...
public class KonakartPage {
	...
	public void konakartValidate(WebDriver driver,Properties prop,String prodname,String review,String price,String index, String search) {
		help.dropDown(prop.getProperty("loc.dropdown.ecom"), driver, Integer.parseInt(index));
		String temp=prodname+","+review+","+price.substring(1);
		String[] temparray=temp.split(",");
		recursiveMethod(driver,prop,search,temparray);
	}
