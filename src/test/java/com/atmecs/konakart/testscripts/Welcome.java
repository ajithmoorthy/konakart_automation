...
public class Welcome extends TestBase {
	...
	public void validateKonakart(String prodname,String review,String price,String index,String search) throws IOException, InterruptedException {
		...
		konakart.konakartValidate(driver, prop,prodname,review,price,index,search);
	}
